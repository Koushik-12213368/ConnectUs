                            ...
                            <div className="carousel-inner rounded-4 shadow">
                                <div className="carousel-item active">
                                    ...
                                    <div className="carousel-caption d-none d-md-block bg-dark bg-opacity-50 rounded-3 p-4">
                                        <h3 className="fw-bold text-center">Student Mental Health Matters</h3>
                                        <p className=" text-center">Access free resources designed for academic success</p>
                                    </div>
                                </div>
                                <div className="carousel-item">
                                    ...
                                    />
                                    <div className="carousel-caption d-none d-md-block bg-dark bg-opacity-50 rounded-3 p-4">
                                        <h3 className="fw-bold text-center">Mindfulness for Focus</h3>
                                        <p className=" text-center">5-minute exercises to reduce stress and boost concentration</p>
                                    </div>
                                </div>
                                <div className="carousel-item">
                                    <img 
                                    ...
                                    />
                                    <div className="carousel-caption d-none d-md-block bg-dark bg-opacity-50 rounded-3 p-4">
                                        <h3 className="fw-bold text-center">Study Smarter, Not Harder</h3>
                                        <p className=" text-center">Evidence-based techniques that actually work</p>
                                    </div>
                                </div>
                            </div>
