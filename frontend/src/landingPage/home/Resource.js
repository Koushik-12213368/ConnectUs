...
function Resource() {
    return (
        <div className="container mt-4 p-3 border-top">
            ...
            <div className="row p-3">
                ...
                <div className="stress-card mt-5">
                    <div className="stress-card-content">
                        ...
                        <Link className="stress-btn" to='/examstress'>
                            Read More →
                        </Link>
                    </div>
                </div>
                ...
                <div className="stress-card mt-5">
                    <div className="stress-card-content">
                        ...
                        <Link className="stress-btn" to='/sleepcycle'>
                            Read More →
                        </Link>
                    </div>
                </div>
                ...
                <div className="stress-card mt-5">
                    <div className="stress-card-content">
                        ...
                        <Link className="stress-btn" to='/impostersyndrome'>
                            Read More →
                        </Link>
                    </div>
                </div>
